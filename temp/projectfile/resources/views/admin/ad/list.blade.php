        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel">
                   <div class="panel-body">
                       <div class="dropdown">
                            <a href="edit_ad_cate" class="btn btn-success">
                               <i class="fa fa-plus-square-o"></i>
                               <span class="bold"> 添加广告位</span>
                            </a>
                        </div>
                   </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-hover text-center table-vam">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">当前在线</th>
                                    <th class="text-center">广告数</th>
                               ...
                               <tr>
                                  ...
                                  <td>
                                    <a href="#" class="btn btn-info btn-xs">查看</a>
                                     <a href="edit_ad_cate" class="btn btn-info btn-xs">编辑</a>
